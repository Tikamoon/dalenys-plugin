...
class Dalenys
{
    const TEST = "https://secure-test.dalenys.com/front/form/process";
    const SIMULATION = "https://secure-test.dalenys.com/front/form/process";
    ...
    // Traitement des reponses de Dalenys
    // -----------------------------------
